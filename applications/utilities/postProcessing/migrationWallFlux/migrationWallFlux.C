...
void Foam::functionObjects::migrationWallFlux::writeFileHeader(const label i)
{
    ...
    writeTabbed(file(), "Average current density (A/m2)");
 ...
 
{
	...
	new volScalarField
        (
            ...
            mesh_,
            dimensionedScalar("0", fi_.dimensions()/dimTime*dimLength, 0.0)
        )
    );
